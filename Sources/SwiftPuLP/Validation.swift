...
// Utility extension for creating an array generated by given collect function.
fileprivate extension Array {
    
    // Initializer using a collect function.
    init(consuming collector: (inout [Element]) -> ()) {
        var elements = Self()
...
extension Variable {
    ...
    public var validationErrors: [ValidationError] {
        [ValidationError](consuming: collectErrors)
    }
